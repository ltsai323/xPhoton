...
static char EBFile[] = "external/autumn18_EB_TMVAnalysis_BDT.weights.xml";
static char EEFile[] = "external/autumn18_EE_TMVAnalysis_BDT.weights.xml";
...
float select_photon_mva(TreeReader &data, Int_t i, TGraph *tgr[20]) {
  ...
  Float_t* phoR9             = data.GetPtrFloat("phoR9");
  Float_t* phoSigmaIEtaIEta  = data.GetPtrFloat("phoSigmaIEtaIEtaFull5x5");
  Float_t* phoSigmaIEtaIPhi  = data.GetPtrFloat("phoSigmaIEtaIPhiFull5x5");
