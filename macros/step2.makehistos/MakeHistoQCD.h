...
// Mon Jun 24 15:30:34 2024 by ROOT version 6.22/09
// from TTree t/mini tree
// found on file: qcd.madgraph.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("qcd.madgraph.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("qcd.madgraph.root");
      }
      f->GetObject("t",tree);
