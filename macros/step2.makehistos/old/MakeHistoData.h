...
// Wed Mar  8 21:32:43 2023 by ROOT version 6.14/09
// from TTree t/mini tree
// found on file: UL16PostVFP_data.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("UL16PostVFP_data.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("UL16PostVFP_data.root");
      }
      f->GetObject("t",tree);
