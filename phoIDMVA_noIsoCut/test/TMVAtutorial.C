...
int TMVAtutorial( bool isEndcap, TString myMethodList = "" )
{
    ...
    TString fname = "../scripts/rw_out.root";
    //TString fname = "../scripts/rw_out.fullsample.root";
    ...
    TTree *signalTree     = (TTree*)input->Get("tt");
    TTree *background     = (TTree*)input->Get("tt");
   ...
   // dataloader->SetBackgroundWeightExpression("puwei*mcweight*weight2d");
    ...
    if (Use["BDTG"]) // Gradient Boost
        factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDTG",
                "!H:!V:NTrees=2000:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=0.10:UseBaggedBoost:BaggedSampleFraction=0.5:nCuts=2000:MaxDepth=2" );

    if (Use["BDT"])  // Adaptive Boost
        //factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDT",
        //        "!H:!V:NTrees=850:MinNodeSize=2.5%:MaxDepth=6:BoostType=AdaBoost:AdaBoostBeta=0.5:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=20" );
...
int main( int argc, char** argv )
{
    ...
    return TMVAtutorial(methodList);
}
