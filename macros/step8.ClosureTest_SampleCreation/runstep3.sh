#!/usr/bin/env sh
touch storeroot/fragmentsIsovsBDT; /bin/rm -r storeroot/fragmentsIsovsBDT
mkdir -p storeroot/fragmentsIsovsBDT/logs
...
touch storeroot/logs; /bin/rm -r storeroot/logs
mkdir -p storeroot/logs
