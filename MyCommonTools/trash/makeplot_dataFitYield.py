...
if __name__ == "__main__":
    ...
    f1 = inputs.FileWithDesc(
            file='/wk_cms3/ltsai/wk_cms/ltsai/ReceivedFile/GJet/latestsample/UL2016PreVFP/makehistos/DeepCSV_gjetPythia_cutIdx5_mergeBin_Orig/CTagSimultaneousFit/UL2016.CTag_SimulFit.csv',
            desc='simultaneous fit')
