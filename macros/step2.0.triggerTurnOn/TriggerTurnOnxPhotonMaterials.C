...
{ return Form("( ((phoFiredTrgs>>%d)&1) == 0 )", ibit); }
...
int BitName(int idx0, int idx1 = -1 )
{
...
void TriggerTurnOnxPhotonMaterials(const char* ifile = "../2016.data.root", const char* ofile = "HLTTurnOnChecking.root")
{
