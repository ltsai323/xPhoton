...
overallGenWeightDict={
  "GJet_Pt-20to40_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8":
  'test_gg/GJet_Pt-20to40_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8.root',
  "GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8":
  'test_gg/GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8.root',
  "GJet_Pt-20toInf_DoubleEMEnriched_MGG-40to80_TuneCP5_13TeV_Pythia8":
  'test_gg/GJet_Pt-20toInf_DoubleEMEnriched_MGG-40to80_TuneCP5_13TeV_Pythia8.root',
}
fDict={
  "GJet_Pt-20to40_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8": {
    "v17-v6":
...
def GetSumGenWeigFromGGNtuple(ifilename):
    ifile = ROOT.TFile.Open(ifilename)
    ihist = ifile.Get('ggNtuplizer/hSumGenWeight')
    return ihist.Integral()
...
if __name__ == '__main__':
    ...
    for pd, info in targetDict.items():
        sumgenweight = GetSumGenWeigFromGGNtuple(overallGenWeightDict[pd])
        ...
        for ver, rootfile in info.items():
            ...
            print( pd, integratedgenweights[pd], sumgenweight, integratedgenweights[pd]-sumgenweight )
