...
void BuildingCandidate(readMgr* mgr, int NNN);
...
//         // ignored code start !asdf
//         // DISABLED: failedpreselection_evt {{{
//         if(isData==1){    //25ns
...
//         // failedpreselection_evt end }}}
        ...
        // lots of parameter declared section {{{
        ...
        // lots of parameter declared section end }}}
        ...
        { truthmatchedObj = mcTruthMatching(&data); }
        LOG_DEBUG("real mcTruthMatching");
        // DISABLED:   mcTruthMatching {{{
//        if(!isData)
//        {
//            vector<int> mcid;
//            int nnMC=0;
...
//        }
        ...
        // Jet info section end }}}

        LOG_DEBUG("gamma+jet section");
        // gamma+jet section {{{
        int nnjet=0;
        int jet2_index=-1;
        if(isData==1)
