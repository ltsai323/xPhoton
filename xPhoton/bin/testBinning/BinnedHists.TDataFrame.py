...
if __name__ == "__main__":
    ...
    etabinning=( (pEtaBin,jEtaBin)
            for pEtaBin in range(1)
            for jEtaBin in range(1) )
    ptbinning=( pPtBin for pPtBin in range(1) )

    for pEtaBin, jEtaBin in etabinning:
        etabinneddata=dataframe.Filter( 'bin_phoeta==%d && bin_jeteta==%d'%(pEtaBin,jEtaBin) )
        etabinnedsign=signframe.Filter( 'bin_phoeta==%d && bin_jeteta==%d'%(pEtaBin,jEtaBin) )
        etabinnedfake=fakeframe.Filter( 'bin_phoeta==%d && bin_jeteta==%d'%(pEtaBin,jEtaBin) )
