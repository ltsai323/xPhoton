...
// Mon Feb  7 21:33:01 2022 by ROOT version 6.12/07
// from TTree t/mini tree
// found on file: /home/ltsai/ReceivedFile/GJet/latestsample/Run2016_Legacy.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/ltsai/ReceivedFile/GJet/latestsample/Run2016_Legacy.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/ltsai/ReceivedFile/GJet/latestsample/Run2016_Legacy.root");
      }
      f->GetObject("t",tree);
