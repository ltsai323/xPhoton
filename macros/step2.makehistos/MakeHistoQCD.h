...
// Mon Mar 13 02:44:03 2023 by ROOT version 6.14/09
// from TTree t/mini tree
// found on file: /home/ltsai/ReceivedFile/GJet/latestsample/2016ReReco_ctagReshaped/QCD_madgraph_ctagReshape.root
//////////////////////////////////////////////////////////

#ifndef MakeHistoQCD_h
#define MakeHistoQCD_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   MakeHistoQCD(TTree *tree=0);
   virtual ~MakeHistoQCD();
...
#ifdef MakeHistoQCD_cxx
MakeHistoQCD::MakeHistoQCD(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/ltsai/ReceivedFile/GJet/latestsample/2016ReReco_ctagReshaped/QCD_madgraph_ctagReshape.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/ltsai/ReceivedFile/GJet/latestsample/2016ReReco_ctagReshaped/QCD_madgraph_ctagReshape.root");
      }
      f->GetObject("t",tree);
...
MakeHistoQCD::~MakeHistoQCD()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MakeHistoQCD::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MakeHistoQCD::LoadTree(Long64_t entry)
{
...
void MakeHistoQCD::Init(TTree *tree)
{
...
void MakeHistoQCD::Show(Long64_t entry)
{
...
Int_t MakeHistoQCD::Cut(Long64_t entry)
{
