...
// Fri Jun 14 14:00:23 2024 by ROOT version 6.22/09
// from TTree t/mini tree
// found on file: bkgRunning/GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8/output_job_PhotonHFJet_19.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("bkgRunning/GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8/output_job_PhotonHFJet_19.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("bkgRunning/GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8/output_job_PhotonHFJet_19.root");
      }
      f->GetObject("t",tree);
