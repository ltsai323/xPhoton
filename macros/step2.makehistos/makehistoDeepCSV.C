...
void LoopQCD( Int_t extracut, const char* dataERA, const char* dataTYPE, const char* inputfilename, int processNEvt = -1 )
{
    ...
    Hists_CTagReshaped* jettag0_QCD_DiJetL_dataSideband = new Hists_CTagReshaped("jettag0_QCD_DiJetL_dataSideband", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_QCD_DiJetC_signalRegion = new Hists_CTagReshaped("jettag0_QCD_DiJetC_signalRegion", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_QCD_DiJetC_dataSideband = new Hists_CTagReshaped("jettag0_QCD_DiJetC_dataSideband", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_QCD_DiJetB_signalRegion = new Hists_CTagReshaped("jettag0_QCD_DiJetB_signalRegion", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_QCD_DiJetB_dataSideband = new Hists_CTagReshaped("jettag0_QCD_DiJetB_dataSideband", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_QCD_GJetsL_signalRegion = new Hists_CTagReshaped("jettag0_QCD_GJetsL_signalRegion", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_QCD_GJetsL_dataSideband = new Hists_CTagReshaped("jettag0_QCD_GJetsL_dataSideband", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_QCD_GJetsC_signalRegion = new Hists_CTagReshaped("jettag0_QCD_GJetsC_signalRegion", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_QCD_GJetsC_dataSideband = new Hists_CTagReshaped("jettag0_QCD_GJetsC_dataSideband", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_QCD_GJetsB_signalRegion = new Hists_CTagReshaped("jettag0_QCD_GJetsB_signalRegion", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_QCD_GJetsB_dataSideband = new Hists_CTagReshaped("jettag0_QCD_GJetsB_dataSideband", "DeepCSV.bScore");

    Hists_CTagReshaped* jettag1_QCD_DiJetL_signalRegion = new Hists_CTagReshaped("jettag1_QCD_DiJetL_signalRegion", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_QCD_DiJetL_dataSideband = new Hists_CTagReshaped("jettag1_QCD_DiJetL_dataSideband", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_QCD_DiJetC_signalRegion = new Hists_CTagReshaped("jettag1_QCD_DiJetC_signalRegion", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_QCD_DiJetC_dataSideband = new Hists_CTagReshaped("jettag1_QCD_DiJetC_dataSideband", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_QCD_DiJetB_signalRegion = new Hists_CTagReshaped("jettag1_QCD_DiJetB_signalRegion", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_QCD_DiJetB_dataSideband = new Hists_CTagReshaped("jettag1_QCD_DiJetB_dataSideband", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_QCD_GJetsL_signalRegion = new Hists_CTagReshaped("jettag1_QCD_GJetsL_signalRegion", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_QCD_GJetsL_dataSideband = new Hists_CTagReshaped("jettag1_QCD_GJetsL_dataSideband", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_QCD_GJetsC_signalRegion = new Hists_CTagReshaped("jettag1_QCD_GJetsC_signalRegion", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_QCD_GJetsC_dataSideband = new Hists_CTagReshaped("jettag1_QCD_GJetsC_dataSideband", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_QCD_GJetsB_signalRegion = new Hists_CTagReshaped("jettag1_QCD_GJetsB_signalRegion", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_QCD_GJetsB_dataSideband = new Hists_CTagReshaped("jettag1_QCD_GJetsB_dataSideband", "DeepCSV.CvsL");

    Hists_CTagReshaped* jettag2_QCD_DiJetL_signalRegion = new Hists_CTagReshaped("jettag2_QCD_DiJetL_signalRegion", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_QCD_DiJetL_dataSideband = new Hists_CTagReshaped("jettag2_QCD_DiJetL_dataSideband", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_QCD_DiJetC_signalRegion = new Hists_CTagReshaped("jettag2_QCD_DiJetC_signalRegion", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_QCD_DiJetC_dataSideband = new Hists_CTagReshaped("jettag2_QCD_DiJetC_dataSideband", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_QCD_DiJetB_signalRegion = new Hists_CTagReshaped("jettag2_QCD_DiJetB_signalRegion", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_QCD_DiJetB_dataSideband = new Hists_CTagReshaped("jettag2_QCD_DiJetB_dataSideband", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_QCD_GJetsL_signalRegion = new Hists_CTagReshaped("jettag2_QCD_GJetsL_signalRegion", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_QCD_GJetsL_dataSideband = new Hists_CTagReshaped("jettag2_QCD_GJetsL_dataSideband", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_QCD_GJetsC_signalRegion = new Hists_CTagReshaped("jettag2_QCD_GJetsC_signalRegion", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_QCD_GJetsC_dataSideband = new Hists_CTagReshaped("jettag2_QCD_GJetsC_dataSideband", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_QCD_GJetsB_signalRegion = new Hists_CTagReshaped("jettag2_QCD_GJetsB_signalRegion", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_QCD_GJetsB_dataSideband = new Hists_CTagReshaped("jettag2_QCD_GJetsB_dataSideband", "DeepCSV.CvsB");
...
void LoopSIG( Int_t extracut, const char* dataERA, const char* dataTYPE, const char* inputfilename, int processNEvt = -1 )
{
    ...
    Hists_CTagReshaped* jettag0_gjet_DiJetL_signalRegion = new Hists_CTagReshaped("jettag0_gjet_DiJetL_signalRegion", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_gjet_DiJetL_dataSideband = new Hists_CTagReshaped("jettag0_gjet_DiJetL_dataSideband", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_gjet_DiJetC_signalRegion = new Hists_CTagReshaped("jettag0_gjet_DiJetC_signalRegion", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_gjet_DiJetC_dataSideband = new Hists_CTagReshaped("jettag0_gjet_DiJetC_dataSideband", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_gjet_DiJetB_signalRegion = new Hists_CTagReshaped("jettag0_gjet_DiJetB_signalRegion", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_gjet_DiJetB_dataSideband = new Hists_CTagReshaped("jettag0_gjet_DiJetB_dataSideband", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_gjet_GJetsL_signalRegion = new Hists_CTagReshaped("jettag0_gjet_GJetsL_signalRegion", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_gjet_GJetsL_dataSideband = new Hists_CTagReshaped("jettag0_gjet_GJetsL_dataSideband", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_gjet_GJetsC_signalRegion = new Hists_CTagReshaped("jettag0_gjet_GJetsC_signalRegion", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_gjet_GJetsC_dataSideband = new Hists_CTagReshaped("jettag0_gjet_GJetsC_dataSideband", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_gjet_GJetsB_signalRegion = new Hists_CTagReshaped("jettag0_gjet_GJetsB_signalRegion", "DeepCSV.bScore");
    Hists_CTagReshaped* jettag0_gjet_GJetsB_dataSideband = new Hists_CTagReshaped("jettag0_gjet_GJetsB_dataSideband", "DeepCSV.bScore");

    Hists_CTagReshaped* jettag1_gjet_DiJetL_signalRegion = new Hists_CTagReshaped("jettag1_gjet_DiJetL_signalRegion", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_gjet_DiJetL_dataSideband = new Hists_CTagReshaped("jettag1_gjet_DiJetL_dataSideband", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_gjet_DiJetC_signalRegion = new Hists_CTagReshaped("jettag1_gjet_DiJetC_signalRegion", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_gjet_DiJetC_dataSideband = new Hists_CTagReshaped("jettag1_gjet_DiJetC_dataSideband", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_gjet_DiJetB_signalRegion = new Hists_CTagReshaped("jettag1_gjet_DiJetB_signalRegion", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_gjet_DiJetB_dataSideband = new Hists_CTagReshaped("jettag1_gjet_DiJetB_dataSideband", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_gjet_GJetsL_signalRegion = new Hists_CTagReshaped("jettag1_gjet_GJetsL_signalRegion", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_gjet_GJetsL_dataSideband = new Hists_CTagReshaped("jettag1_gjet_GJetsL_dataSideband", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_gjet_GJetsC_signalRegion = new Hists_CTagReshaped("jettag1_gjet_GJetsC_signalRegion", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_gjet_GJetsC_dataSideband = new Hists_CTagReshaped("jettag1_gjet_GJetsC_dataSideband", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_gjet_GJetsB_signalRegion = new Hists_CTagReshaped("jettag1_gjet_GJetsB_signalRegion", "DeepCSV.CvsL");
    Hists_CTagReshaped* jettag1_gjet_GJetsB_dataSideband = new Hists_CTagReshaped("jettag1_gjet_GJetsB_dataSideband", "DeepCSV.CvsL");

    Hists_CTagReshaped* jettag2_gjet_DiJetL_signalRegion = new Hists_CTagReshaped("jettag2_gjet_DiJetL_signalRegion", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_gjet_DiJetL_dataSideband = new Hists_CTagReshaped("jettag2_gjet_DiJetL_dataSideband", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_gjet_DiJetC_signalRegion = new Hists_CTagReshaped("jettag2_gjet_DiJetC_signalRegion", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_gjet_DiJetC_dataSideband = new Hists_CTagReshaped("jettag2_gjet_DiJetC_dataSideband", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_gjet_DiJetB_signalRegion = new Hists_CTagReshaped("jettag2_gjet_DiJetB_signalRegion", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_gjet_DiJetB_dataSideband = new Hists_CTagReshaped("jettag2_gjet_DiJetB_dataSideband", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_gjet_GJetsL_signalRegion = new Hists_CTagReshaped("jettag2_gjet_GJetsL_signalRegion", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_gjet_GJetsL_dataSideband = new Hists_CTagReshaped("jettag2_gjet_GJetsL_dataSideband", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_gjet_GJetsC_signalRegion = new Hists_CTagReshaped("jettag2_gjet_GJetsC_signalRegion", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_gjet_GJetsC_dataSideband = new Hists_CTagReshaped("jettag2_gjet_GJetsC_dataSideband", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_gjet_GJetsB_signalRegion = new Hists_CTagReshaped("jettag2_gjet_GJetsB_signalRegion", "DeepCSV.CvsB");
    Hists_CTagReshaped* jettag2_gjet_GJetsB_dataSideband = new Hists_CTagReshaped("jettag2_gjet_GJetsB_dataSideband", "DeepCSV.CvsB");
...
void LoopData( Int_t extracut, const char* dataERA, const char* dataTYPE, const char* inputfilename, int processNEvt = -1 )
{
    ...
    Hists* jettag0_data_signalRegion = Hists_CTags("jettag0_data_signalRegion", "DeepCSV.bScore");
    Hists* jettag0_data_dataSideband = Hists_CTags("jettag0_data_dataSideband", "DeepCSV.bScore");

    Hists* jettag1_data_signalRegion = Hists_CTags("jettag1_data_signalRegion", "DeepCSV.CvsL");
    Hists* jettag1_data_dataSideband = Hists_CTags("jettag1_data_dataSideband", "DeepCSV.CvsL");

    Hists* jettag2_data_signalRegion = Hists_CTags("jettag2_data_signalRegion", "DeepCSV.CvsB");
    Hists* jettag2_data_dataSideband = Hists_CTags("jettag2_data_dataSideband", "DeepCSV.CvsB");
    ...
    for (Long64_t jentry=0; jentry<nentries;jentry++)
    {
        ...
        if ( evtbin.isSignalRegion )
        {
            ...
            Fill(evtbin,jettag0_data_signalRegion, load_data.DeepCSV_bScore,eventweight);
            Fill(evtbin,jettag1_data_signalRegion, load_data.DeepCSV_CvsL,eventweight);
            Fill(evtbin,jettag2_data_signalRegion, load_data.DeepCSV_CvsB,eventweight);
        ...
        if ( evtbin.isDataSideband )
        {
            ...
            Fill(evtbin,jettag0_data_dataSideband, load_data.DeepCSV_bScore,eventweight);
            Fill(evtbin,jettag1_data_dataSideband, load_data.DeepCSV_CvsL,eventweight);
            Fill(evtbin,jettag2_data_dataSideband, load_data.DeepCSV_CvsB,eventweight);
