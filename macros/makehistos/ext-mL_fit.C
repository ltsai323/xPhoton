...
Int_t ptbin_lowedge(float ptbin){
  int ptbin_int=0;  
...
Double_t* Ifit(float ptbin=13, char EBEE[10]="EB", int fit_data=1, int jetbin=0)
{
  ...
  if(fit_data==1 || fit_data==11){ //1 norminal fit; 11 fit with toy template
    ...
    if(ebee==1 && jetbin==1 && ptbin_int==21)     sprintf(hname,"gjet_%d_%d_%d_px1_chIso",ebee, jetbin, 20);
    ...
    if(ptbin_int >=19) sprintf(hname,"data_%d_%d_%d_px2_chIso",ebee, jetbin, 18);
    if(ebee==0 && jetbin==1 && ptbin_int >=18) sprintf(hname,"data_%d_%d_%d_px2_chIso",ebee, jetbin, 17);
    //if(ebee==1 && jetbin<=1 && ptbin_int >=18) sprintf(hname,"data_%d_%d_%d_px2_chIso",ebee, jetbin, 17);
