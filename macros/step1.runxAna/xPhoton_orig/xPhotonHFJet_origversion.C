...
#include "interface/PhotonSelections.h"
#include "interface/MuonSelections.h"
#include "interface/ElectronSelections.h"
#include "interface/puweicalc.h"
...
void xPhotonHFJet(vector<string> pathes, Char_t oname[200]){
  ...
  if(isMC==1)   {
    ...
    f = TFile::Open("external/transformation_76X_v2.root");
