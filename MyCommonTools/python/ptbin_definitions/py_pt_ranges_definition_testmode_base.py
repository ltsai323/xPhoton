...
# test mode == 4
def pt_ranges_test_for_merge_bin_test4(dataERA):
    if dataERA == '2016ReReco' or dataERA == 'UL2016PreVFP' or dataERA == 'UL2016PostVFP':
        return (25,34,40,56,70,85,100,115,135,155,190,200,220,300,400,500,750,1000)
def hltbin_ptbin_definition_merbe_bin_test4(dataERA):
    if dataERA == '2016ReReco' or dataERA == 'UL2016PreVFP' or dataERA == 'UL2016PostVFP':
        return ( 0, 1, 2, 3, 3, 4,  5,  5,  6,  6,  7,  7,  7,  7,  8,  8,  8,   8)
# test mode == 5
def pt_ranges_test_for_merge_bin_test5(dataERA):
    if dataERA == '2016ReReco' or dataERA == 'UL2016PreVFP' or dataERA == 'UL2016PostVFP':
        return (25,34,40,56,70,85,100,115,135,    190,200,220,300,400,500,750,1000)
def hltbin_ptbin_definition_merbe_bin_test5(dataERA):
    if dataERA == '2016ReReco' or dataERA == 'UL2016PreVFP' or dataERA == 'UL2016PostVFP':
        return ( 0, 1, 2, 3, 3, 4,  5,  5,  6,      7,  7,  7,  7,  8,  8,  8,   8)
# test mode == 9
def pt_ranges_test_for_merge_bin_test9(dataERA):
    if dataERA == '2016ReReco' or dataERA == 'UL2016PreVFP' or dataERA == 'UL2016PostVFP':
        return (190,200,220,250,300,350,400,500,750,1000)
def hltbin_ptbin_definition_merbe_bin_test9(dataERA):
    if dataERA == '2016ReReco' or dataERA == 'UL2016PreVFP' or dataERA == 'UL2016PostVFP':
...
def PhoPtBinning(dataERA, testMODE):
    if testMODE == -1:
    ...
    if testMODE == 4:
        return pt_ranges_test_for_merge_bin_test4(dataERA)
    if testMODE == 5:
        return pt_ranges_test_for_merge_bin_test5(dataERA)
    if testMODE == 9:
        return pt_ranges_test_for_merge_bin_test9(dataERA)
def hltbin_ptbin_definition(dataERA, testMODE):
    if testMODE == -1:
    ...
    if testMODE == 4:
        return hltbin_ptbin_definition_merbe_bin_test4(dataERA)
    if testMODE == 5:
        return hltbin_ptbin_definition_merbe_bin_test5(dataERA)
    if testMODE == 9:
        return hltbin_ptbin_definition_merbe_bin_test9(dataERA)
    return None
def FindEffLumi(dataERA, ptBIN, testMODE):
    ...
    ggbit = hltbin_ptbin_definition(dataERA, testMODE)[ptBIN]
...
if __name__ == "__main__":
    ...
    pho_pt_def = PhoPtBinning(currentDataEra, testmode)
    hlt_bining = hltbin_ptbin_definition(currentDataEra, testmode)
    for idx,hltbit in enumerate(hlt_bining):
        print(f'@pt bin {idx:2d} : {get_pt_region(pho_pt_def,idx)} \t with hlt bin {hltbit} and eff lumi {FindEffLumi(currentDataEra,idx,testmode)}')
