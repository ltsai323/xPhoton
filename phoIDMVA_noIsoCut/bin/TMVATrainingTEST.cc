...
//    factory->AddVariable( "var4",                "Variable 4", "units", 'F' );
   ...
   dataloader->AddSpectator( "recoPhi", "recoPhi", "none",   'F' );   // Use this to check the null hypothesis
...
//    mycutb = "isMatched!=1&&isMatchedEle==-1&&TMath::Abs(recoEta)<1.5&&recoPt>200.";
   ...
   dataloader->PrepareTrainingAndTestTree( mycuts, mycutb, "SplitMode=Random:SplitSeed=100:nTrain_Signal=30000:nTest_Signal=30000");  //for EB TMVA420 summer16 all vertex
...
//                            "!H:!V:NTrees=850:nEventsMin=150:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:SeparationType=GiniIndex:nCuts=20:PruneMethod=NoPruning" );
   ...
   if (Use["BDT"]) {
     ...
     //by Inna in 2016
     // asdf factory->BookMethod(dataloader, TMVA::Types::kBDT, "BDT","!H:!V:NTrees=2000:BoostType=Grad:Shrinkage=0.10:!UseBaggedGrad:nCuts=2000:UseNvars=4:PruneStrength=5:PruneMethod=CostComplexity:MaxDepth=6:NegWeightTreatment=IgnoreNegWeightsInTraining");
     factory->BookMethod(dataloader, TMVA::Types::kBDT, "BDT","!H:!V:NTrees=2000:BoostType=Grad:Shrinkage=0.10:!UseBaggedGrad:nCuts=2000:UseNvars=4:PruneStrength=5:PruneMethod=CostComplexity:MaxDepth=3:NegWeightTreatment=IgnoreNegWeightsInTraining");
     //Adaboost
