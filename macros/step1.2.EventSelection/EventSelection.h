...
// Sun Oct 10 00:33:01 2021 by ROOT version 6.10/09
// from TTree t/mini tree
// found on file: /home/ltsai/ReceivedFile/GJet/latestsample/QCD_madgraph.root
//////////////////////////////////////////////////////////
...
#ifdef EventSelection_cxx
EventSelection::EventSelection(TTree *tree) : fChain(0) 
{
    // if parameter tree is not specified (or zero), connect the file
    // used to generate this class and read the Tree.
    if (tree == 0) {
        TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/ltsai/ReceivedFile/GJet/latestsample/QCD_madgraph.root");
        if (!f || !f->IsOpen()) {
            f = new TFile("/home/ltsai/ReceivedFile/GJet/latestsample/QCD_madgraph.root");
        }
        f->GetObject("t",tree);
...
Int_t EventSelection::GetEntry(Long64_t entry)
{
    // Read contents of entry.
    if (!fChain) return 0;
    return fChain->GetEntry(entry);
}
Long64_t EventSelection::LoadTree(Long64_t entry)
{
...
void EventSelection::Show(Long64_t entry)
{
...
Int_t EventSelection::Cut(Long64_t entry)
{
...
#endif // #ifdef EventSelection_cxx
