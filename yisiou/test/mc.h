...
// Mon Feb  7 21:51:25 2022 by ROOT version 6.12/07
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/ltsai/ReceivedFile/GJet/latestsample/sigMC_madgraph.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/ltsai/ReceivedFile/GJet/latestsample/sigMC_madgraph.root");
      }
      f->GetObject("t",tree);
