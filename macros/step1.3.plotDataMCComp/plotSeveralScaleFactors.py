...
listOfFile = [
    { 'path' : 'results/UL2016_preVFP/tnpPhoID/myphoselwithsignalreg/egammaEffi.txt_EGM2D.root' , 'legend' : 'UL2016PreVFP 19.52/fb' , 'color' : rt.kAzure},
    { 'path' : 'results/UL2016_postVFP/tnpPhoID/myphoselwithsignalreg/egammaEffi.txt_EGM2D.root', 'legend' : 'UL2016PreVFP 16.81/fb' , 'color' : rt.kAzure},
]



grNames = [ 'grSF1D_0','grSF1D_1','grSF1D_2','grSF1D_3','grSF1D_4', ]
