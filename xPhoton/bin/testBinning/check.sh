...
TH1F* hCmp = (TH1F*) fCmp->Get( Form("photonFit_%d_%d_%d/data_signalRegion",pEtaBin,jEtaBin,pPtBin) );
...
for ( int jEtaBin = 0; jEtaBin < 2; ++jEtaBin ) {
for ( int pPtBin = 0; pPtBin < 21; ++pPtBin ) {
TH1F* hTrg = (TH1F*) fTrg->Get( Form("data_%d_%d_%d_px2_chIso",pEtaBin,jEtaBin,pPtBin) );
TH1F* hCmp = (TH1F*) fCmp->Get( Form("photonFit_%d_%d_%d/data_sidebandRegion",pEtaBin,jEtaBin,pPtBin) );
...
for ( int jEtaBin = 0; jEtaBin < 2; ++jEtaBin ) {
for ( int pPtBin = 0; pPtBin < 21; ++pPtBin ) {
TH1F* hTrg = (TH1F*) fTrg->Get( Form("data_%d_%d_%d_all",pEtaBin,jEtaBin,pPtBin) );
TH1F* hCmp = (TH1F*) fCmp->Get( Form("photonFit_%d_%d_%d/data_allRegion",pEtaBin,jEtaBin,pPtBin) );
