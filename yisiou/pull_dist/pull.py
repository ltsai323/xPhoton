...
ptbin = int(sys.argv[1])

for num in range(ptbin, ptbin+1):
    ...
    outfile.write("\n")
    outfile.write("shapes data_obs cat0 ./toy.root btag \n"  ) 
    outfile.write("shapes data_obs cat1 ./toy.root cvsl \n"  ) 
    outfile.write("shapes data_obs cat2 ./toy.root cvsb \n"  ) 
    outfile.write("shapes data_obs cat3 ./toy.root mass \n"  ) 
    outfile.write("--------------- \n")
